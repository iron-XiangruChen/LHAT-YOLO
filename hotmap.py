...
class yolov8_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            self.process(img_path, f'{save_path}/result.jpg')


def get_params():
    params = {
        'weight': r'D:\py\cxr\ultralytics-yolo11-main\runs\detect\V11-100\weights\best.pt',  # 现在只需要指定权重即可,不需要指定cfg shale-yolo
        #'weight': r'D:\py\cxr\Shale-Yolo\runs1\detect\train10(V8)\weights\best.pt',# 现在只需要指定权重即可,不需要指定cfg V8
        'device': 'cuda:0',
        'method': 'GradCAM',
...
if __name__ == '__main__':
    ...
    model(r'E:\实验室资料\论文撰写\深度学习-施工现场\图像与数据\图6\原图', r'E:\实验室资料\论文撰写\深度学习-施工现场\图像与数据\图7\TEST')
    # model(r'E:\hotmap2\SkyFusion', r'E:\hotmap2\SkyFusion_shale_yolo')