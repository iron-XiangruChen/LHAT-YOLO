...
if __name__ == '__main__':
    model_path = r'D:\py\cxr\ultralytics-yolo11-main\runs\detect\V11+层数+GSConv+LSDECD\weights\best.pt'
    model = YOLO(model_path) # 选择训练好的权重路径
    result = model.val(data=r'D:\py\cxr\ultralytics-yolo11-main\ultralytics\cfg\datasets\my1_coco128.yaml',
